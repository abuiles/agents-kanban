...
| Repositories | 2 | ✅ Implemented | `GET /api/repos`; `POST /api/repos`; `PATCH /api/repos/:repoId`; `DELETE /api/repos/:repoId` | _none_ | Repo create/edit/list/delete are in place. |
