/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f23b0e0e2b4db1540b1d64f3499fdfdc)
// Runtime types generated with workerd@1.20260305.0 2026-03-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Sandbox" | "BoardIndexDO" | "RepoBoardDO";
	}
	interface Env {
		...
		BOARD_INDEX: DurableObjectNamespace<import("./src/index").BoardIndexDO>;
		REPO_BOARD: DurableObjectNamespace<import("./src/index").RepoBoardDO>;
